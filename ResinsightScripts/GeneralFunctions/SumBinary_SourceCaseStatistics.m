...
for i = 1 : numCase
  ...
  if ( strcmp(Cases(i).CaseType,"SourceCase") );		# true when equal 
...
riSetGridProperty(SumBinary, caseListId(1),0,"SumBinary");	# return parameter to ResInsights first case in list
