...
# Calculate sum FIPOIL for selected layers for main grid
...
riSetGridProperty(SOIL3D_sum,GridNo,"FIPOIL_sum_per_zone");
...
riSetGridProperty(FIPOILDIFF,GridNo,"FIPOIL_sum_per_zones_dt_DIFF");
